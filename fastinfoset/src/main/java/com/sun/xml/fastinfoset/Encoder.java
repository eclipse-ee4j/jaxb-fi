...
public abstract class Encoder extends DefaultHandler implements FastInfosetSerializer {
    ...
    static {
        ...
        Arrays.fill(NUMERIC_CHARACTERS_TABLE, -1);
        Arrays.fill(DATE_TIME_CHARACTERS_TABLE, -1);
     ...
     */
    private Map<String, EncodingAlgorithm> _registeredEncodingAlgorithms = new HashMap<>();
    ...
    @Override
    public void setRegisteredEncodingAlgorithms(final Map<String, EncodingAlgorithm> algorithms) {
    ...
    protected final void encodeNonZeroIntegerOnSecondBitFirstBitOne(int i) throws IOException {
        if (i < EncodingConstants.INTEGER_2ND_BIT_SMALL_LIMIT) {
            ...
            throw new IOException(
                    ...
                    new Object[]{EncodingConstants.INTEGER_2ND_BIT_LARGE_LIMIT}));
        }
    }
